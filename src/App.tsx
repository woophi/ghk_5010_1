...
const dataStep0 = [
  {
    ...
    subtitle: 'Для новых денег от 10 000 ₽, которые не были в накоплениях/активах последние 90 дней',
    img: money,
  },
  {
  ...
  return (
    <>
      <div className={appSt.container}>
        ...
        <div className={appSt.boxRow2Wrap}>
          ...
          <div className={appSt.boxRow2}>
            ...
            <div style={{ marginTop: '-40px' }}>
              ...
              <Typography.Text view="primary-small" color="secondary">
                Для новых денег от 10 000 ₽, которые не были в накоплениях/активах последние 90 дней
              </Typography.Text>
            </div>
        ...
        <div>
          <div className={appSt.rowText} onClick={() => window.gtag('event', '5010_FAQ_var1')}>
            <CDNIcon name="glyph_question-circle_m" />
            <Typography.Text view="primary-medium">Частые вопросы</Typography.Text>
          </div>
          <div className={appSt.rowText} onClick={() => window.gtag('event', '5010_moreinfo_var1')}>
        ...
        <Typography.Text view="primary-small" color="secondary">
          ...
          <span style={{ textDecoration: 'underline' }} onClick={() => window.gtag('event', '5010_newinfo_var1')}>
